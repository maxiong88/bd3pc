var commonJs = {
    ...
    c: function(){
        ...
        var commonHTML = '';
            ...
            commonHTML += '<a href="/" id="homeNav" class="item-home" title="返回主页"></a>';
            commonHTML += '</div>';
        var body = $('body');
    ...
    stig_init:function(url,ell, el){
        var that = this;
        that.mCustomScrollbar(el)
        that.c();
    ...
    arms_details_init: function(url, data, page, pageSize, el){  
        var that = this;
        data.page = page;
        data.pageSize = pageSize;
        data.type = 1;
